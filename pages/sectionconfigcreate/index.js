...
const optionGroup = [
 ...
 const SectionConfigCreate = (props) => {
      ...
      <Layout headbar="Section COnfig Create">
            <div className="container-fluid m-2" style={{backgroundColor: "#FFFFFF"}}>
              <Breadcrumb title="Survey" breadcrumbItem="Survey Configuration" />
                ...
                <Row className="m-3">
                    <Form style={{backgroundColor: "#FAFAFA",borderRadius:'12px'}} className="pt-5 pb-5"  >
                        <FormGroup>
                            <Col md={{offset: 4,size: 4}}>
                                <div className="mb-5">
                                <Label htmlFor="formrow-email-Input">Section Name</Label>
                                <Input
                                    type="email"
                                    className="form-control sectionSsc"
                        ...
                        <FormGroup>
                            <Col md={{offset: 4,size: 4}}>
                                <div className="mb-5 select2-container">
                                    <Label>Frequency</Label>
                                    <div className="">
                                        <select defaultValue="0" className="form-select frequencySsc">
                        ...
                        <div  className="text-center mt-2" style={{marginLeft:'-65px'}}>
                            <button type="submit" className="btn btn-primary w-md buttonSsc">
...
export default SectionConfigCreate;